...
from youtube_asr_to_dataset import (
...
DEFAULT_WORKSPACE = "youtube_asr_dataset"
PROJECT_VERSION = 1
WAVEFORM_HEIGHT = 280
...
def save_project(path: Path, project: VideoProject) -> None:
    ...
    payload = {
        ...
        "caption_file": project.caption_file,
        "audio_file": project.audio_file,
        "working_audio_file": project.working_audio_file,
...
def metadata_to_project(root: Path, payload: dict[str, Any]) -> VideoProject:
    ...
    return VideoProject(
        ...
        working_audio_file=str(working_audio),
        created_at=now,
        updated_at=now,
